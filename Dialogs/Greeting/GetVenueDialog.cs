...
namespace Microsoft.BotBuilderSamples
{
    ...
    /// </summary>
    public class GetVenueDialog : ComponentDialog
    {
        ...
        public GetVenueDialog(IStatePropertyAccessor<IntentState> userProfileStateAccessor, ILoggerFactory loggerFactory)
            : base(nameof(GetVenueDialog))
        {
        ...
        public IStatePropertyAccessor<IntentState> UserProfileAccessor { get; }
        ...
        private async Task<DialogTurnResult> InitializeStateStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                var greetingStateOpt = stepContext.Options as IntentState;
                ...
                {
                    await UserProfileAccessor.SetAsync(stepContext.Context, new IntentState());
                }
            }
        ...
        private async Task<DialogTurnResult> PromptForVenueStepAsync(
                                                ...
                                                CancellationToken cancellationToken)
        {
            ...
            if (greetingState != null && !string.IsNullOrWhiteSpace(greetingState.EventPlaceName))
            {
                return await GreetUser(stepContext);
            }

            if (string.IsNullOrWhiteSpace(greetingState.EventPlaceName))
            {
                                                    ...
                                                    CancellationToken cancellationToken)
        {
                ...
                !string.IsNullOrWhiteSpace(lowerCaseCity))
            {
                ...
                greetingState.EventPlaceName = char.ToUpper(lowerCaseCity[0]) + lowerCaseCity.Substring(1);
        ...
        private async Task<DialogTurnResult> GreetUser(WaterfallStepContext stepContext)
        {
            ...
            return await stepContext.NextAsync();//.EndDialogAsync();
